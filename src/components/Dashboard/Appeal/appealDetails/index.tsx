...
import AppealDetailsComponent from "./AppealDetailscomponents";
const AppealDetails = () => {
  return (
    <div className="flex flex-col gap-y-6 px-4 py-8 w-full text-[#667185]">
      <div className="flex items-center m-auto w-full px-24 gap-x-2 text-[14px]">
      ...
      <div className="w-full px-24 flex flex-col gap-y-2">
        <Image
