        ...
        <div className="flex items-center justify-between w-full px-4">
          ...
          </div>
          {
            orderDetails?.status === 'pending' && (
              ...
              <button onClick={() => RejectOrder(orderDetails?.id ? orderDetails?.id : 0)} className="flex items-center bg-[#E4E7EC] py-[8px] px-[12px] rounded-[8px] text-primary-black text-[14px]">
                Decline
              </button>
              <button onClick={() => ApproveOrder(orderDetails?.id ? orderDetails?.id : 0)} className="flex items-center bg-[#CB29BE] py-[8px] px-[12px] rounded-[8px] text-[#ffffff] text-[14px]">
                Approve
                <Icons type="mark" />
              </button>
            </div>
