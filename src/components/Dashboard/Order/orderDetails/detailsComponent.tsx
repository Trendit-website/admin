      ...
      <div className="flex flex-col justify-around w-6/12 gap-y-10 font-normal text-secondary text-[14px] h-[570px] bg-[#F9FAFC] px-4 gap-y-4 py-4 rounded-[12px] border-solid border-[1px] border-borderColor">
        ...
        <div className="flex flex-col gap-y-4">
          ...
          <div className="flex items-center gap-x-2">
            ...
            The link will direct you to a {details?.platform} Page which you are
            meant to follow.
          </div>
          <div className="flex items-start gap-x-2">
            <span className="font-bold text-secondary">Step3:</span>
            Click on the Follow button on the {details?.platform} Page to start
            following the page. You MUST NOT Unfollow the account after you have
          ...
          <div className="flex items-start gap-x-2">
            ...
            You are also required to enter your {details?.platform} Username or
