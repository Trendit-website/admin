        ...
        {details?.social_profiles.map((social, index) => (
          ...
          >
            ...
            <div className="flex flex-col gap-y-[3px]">
              ...
              <div
                className={`flex items-center justify-center w-[84px] h-[22px] rounded-[16px] gap-x-[5px] border-[1px] border-solid ${
                  social?.status === "verified"
                    ? "border-[#067467] bg-[#ABEFC6] text-[#067467]"
                    : social?.status === "pending"
                      ? "border-[#FEDF89] bg-[#FFAEB] text-[#FEDF89]"
                      : "border-[#FECDCA] bg-[#FFAEB] text-red-500"
                } text-[12px]`}
              >
