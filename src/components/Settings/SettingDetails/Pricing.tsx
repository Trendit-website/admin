...
const Pricing = () => {
    const Tabs = ['Advert Task', 'Engagement Task', 'Post Adverts', 'Engagement Adverts']
    ...
    return (
        <div className="flex flex-col gap-y-8">
          ...
          <div className="flex items-center px-6 gap-x-6 text-primary-black w-10/12 border-b-[1px] border-solid border-borderColor">
                {
                    Tabs.map((tab, index) => (
                        <p key={index} onClick={() => setActiveTab(tab)} className={`pb-2 ${activeTab === tab && 'text-main border-main border-solid border-b-[1px]'}`}>
                            {tab}
                        </p>
                    ))
                }
                    ...
                    <tbody className="flex flex-col gap-y-4 text-secondary text-[12px]">
                        ...
                        <td className="flex items-start gap-x-[5px] w-7/12">
                            ...
                            <div className="flex flex-col text-primary-black text-[14px]">
                                ...
                                Post adverts of various businesses and top brands on your Facebook Page
                                </span>
                            </div>
                        </td>
