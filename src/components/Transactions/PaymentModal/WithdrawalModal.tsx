            ...
            <ModalContent className="rounded-[12px] py-2">
                {
                   ...
                   <div className="text-[24px] font-bold">
                    ...
                    <div className="flex flex-col items-center justify-center">
                        ...
                        <span className="text-[12px] text-[#344054]">Processing fee: #50</span>
                    ...
                    <div className="flex flex-col gap-y-4">
                        ...
                        <div className="flex items-center w-full justify-between gap-x-4">
                            <div className="flex items-start">
                                <Image src='/assets/access-logo.png' alt="bank logo" width={40} height={40} />
                    ...
                    <Button clickFunction={() => setActiveModal(modals[1])} classNames="bg-main w-full text-center py-2 text-[#ffffff] font-bold text-[16px] rounded-[8px]" label="Continue"/>
                    </div>
                    )
                }
                 {
                    ...
                    <div className="text-primary-black w-full py-4 flex flex-col px-4 gap-y-8">
                        ...
                        <div className="self-end" onClick={() => setActiveModal(modals[0])}>
                            <Icons type="cancel" />
                        </div>  
                        <div className="text-secondary text-[14px] w-9/12">
                            Enter the otp code that was sent to the <span className="font-bold">administrator’s</span> email, kindly insert
                        </div>
                        <div className="flex items-center justify-center gap-x-2">
                            <input type="number" className="border-solid border-[1px] text-center border-borderColor w-[44px] h-[44px] rounded-[8px]"/>
                            <input type="number" className="border-solid border-[1px] text-center border-borderColor w-[44px] h-[44px] rounded-[8px]"/>
                            <input type="number" className="border-solid border-[1px] text-center border-borderColor w-[44px] h-[44px] rounded-[8px]"/>
                            <input type="number" className="border-solid border-[1px] text-center border-borderColor w-[44px] h-[44px] rounded-[8px]"/>
                        </div>
                        <div className="text-secondary flex justify-center text-[12px]">
                            Didn’t Receive a code? <span className="text-primary-black font-bold">Resend code in 20s </span>
                        </div>
                        <Button classNames="bg-main w-full text-center py-2 text-[#ffffff] font-bold text-[16px] rounded-[8px]" label="Continue"/>
                    </div> 
                    )
                }
            </ModalContent>
